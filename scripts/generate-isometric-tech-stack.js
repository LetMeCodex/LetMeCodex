...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="100%" height="100%">
  ...
  <g id="central-island">
    ...
    <!-- Levitating Crystal Monolith (Purple Octahedron) -->
    <g class="anim-crystal" filter="url(#crystalGlow)">
      <!-- Crystal Shadow on glass top -->
  ...
  <g id="zone-01-web">
    ...
    <!-- Diorama: Desktop Screen with Code & Shrub -->
    ...
    <g class="tile-badge" transform="translate(390, 480)">
      ...
      <ellipse cx="36" cy="36" rx="20" ry="7" fill="none" stroke="#0284c7" stroke-width="3" transform="rotate(30 36 36)" />
      <ellipse cx="36" cy="36" rx="20" ry="7" fill="none" stroke="#0284c7" stroke-width="3" transform="rotate(90 36 36)" />
      <ellipse cx="36" cy="36" rx="20" ry="7" fill="none" stroke="#0284c7" stroke-width="3" transform="rotate(150 36 36)" />
      <circle cx="36" cy="36" r="4.2" fill="#0284c7" />
    ...
    <g class="tile-badge" transform="translate(580, 480)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <path d="M 23 36 C 26 26, 36 26, 39 31 C 42 36, 46 42, 51 42 C 57 42, 59 36, 59 36 C 56 46, 46 46, 43 41 C 40 36, 36 30, 31 30 C 25 30, 23 36, 23 36 Z" fill="#06b6d4" />
    ...
    <!-- Row 2: JavaScript, TypeScript, HTML5 (Staggered forward) -->
    <!-- 5. JavaScript -->
    <g class="tile-badge" transform="translate(435, 575)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <rect x="10" y="10" width="52" height="52" rx="8" fill="#eab308" />
    ...
    <g class="tile-badge" transform="translate(535, 575)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <rect x="10" y="10" width="52" height="52" rx="8" fill="#d97706" />
  ...
  <g id="zone-02-3d">
    ...
    <g class="tile-badge" transform="translate(890, 420)">
      ...
      <polygon points="36,25 46,31 36,37 26,31" fill="#a8a29e" />
    ...
    <g class="tile-badge" transform="translate(1310, 420)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <polygon points="36,17 54,28 36,39 18,28" fill="#818cf8" />
      <polygon points="36,32 54,43 36,54 18,43" fill="#4f46e5" />
  ...
  <g id="zone-03-motion">
    ...
    <g class="tile-badge" transform="translate(1780, 520)">
      ...
      <circle cx="36" cy="36" r="5.5" fill="#b45309" />
    ...
    <g class="tile-badge" transform="translate(2095, 520)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <path d="M 18 26 Q 36 16 54 26" fill="none" stroke="#0f766e" stroke-width="3.8" stroke-linecap="round" />
      <path d="M 18 37 Q 36 27 54 37" fill="none" stroke="#0f766e" stroke-width="3.8" stroke-linecap="round" />
      <path d="M 18 48 Q 36 38 54 48" fill="none" stroke="#0f766e" stroke-width="3.8" stroke-linecap="round" />
  ...
  <g id="zone-04-graphics">
    ...
    <g class="tile-badge" transform="translate(535, 890)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <circle cx="36" cy="36" r="19" fill="none" stroke="#0e7490" stroke-width="5.5" />
  ...
  <g id="zone-05-browser">
    ...
    <g class="tile-badge" transform="translate(1660, 890)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <circle cx="36" cy="36" r="18" fill="none" stroke="#2563eb" stroke-width="4" />
  ...
  <g id="zone-06-engineering">
    ...
    <!-- Tech Badges -->
    <!-- Row 1: Python, Node.js, npm, Git -->
    <!-- 1. Python -->
    <g class="tile-badge" transform="translate(420, 1190)">
      <rect width="72" height="72" rx="14" fill="#FFFFFF" stroke="#E7E4DA" stroke-width="1.5" filter="url(#tileShadow)" />
      <rect x="17" y="15" width="38" height="42" rx="4" fill="#e2ded4" />
      <line x1="23" y1="27" x2="47" y2="27" stroke="#3b82f6" stroke-width="3" stroke-linecap="round" />
      <line x1="23" y1="36" x2="49" y2="36" stroke="#eab308" stroke-width="3" stroke-linecap="round" />
      <line x1="23" y1="45" x2="37" y2="45" stroke="#3b82f6" stroke-width="3" stroke-linecap="round" />
    ...
    <g class="tile-badge" transform="translate(735, 1190)">
      ...
      <circle cx="36" cy="47" r="3.5" fill="#FFFFFF" />
    ...
    <!-- Row 2: GitHub, Playwright, Chrome DevTools (In Front) -->
    <!-- 5. GitHub -->
...
console.log(`[+] Successfully generated refined Isometric Tech Stack Archipelago SVG at: ${outputPath}`);
